...
namespace Merchello.Plugin.Shipping.Other
{
    public static class ExtendedDataExtensions
    {
        ...
        public static void SaveProcessorSettings(this ExtendedDataCollection extendedData, OtherProcessorSettings processorSettings)
        {
        ...
        public static OtherProcessorSettings GetProcessorSettings(this ExtendedDataCollection extendedData)
        {
            if (!extendedData.ContainsKey(Constants.ExtendedDataKeys.ProcessorSettings)) return new OtherProcessorSettings();

            return
                JsonConvert.DeserializeObject<OtherProcessorSettings>(
